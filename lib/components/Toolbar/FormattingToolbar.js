...
var FormattingToolbar = function (_React$Component) {
  ...
  _createClass(FormattingToolbar, [{
    ...
    value: function render() {
      ...
      var isSelectionInHeading = editor.isSelectionInHeading();
      var isSelectionInTable = editor.isSelectionInTable();
      var Tooltip = editor.props.tooltip;

      return React.createElement(
        React.Fragment,
        null,
        !isSelectionInHeading && React.createElement(
          React.Fragment,
          null,
        ...
        !isSelectionInTable && React.createElement(
          React.Fragment,
          null,
          !isSelectionInHeading && React.createElement(_Separator2.default, null),
          this.renderBlockButton("heading1", _outlineIcons.Heading1Icon, "Heading"),
          this.renderBlockButton("heading2", _outlineIcons.Heading2Icon, "Subheading"),
          !isSelectionInHeading && this.renderBlockButton("block-quote", _outlineIcons.BlockQuoteIcon, "Quote")
        ),
        !isSelectionInHeading && React.createElement(
          React.Fragment,
          null,
